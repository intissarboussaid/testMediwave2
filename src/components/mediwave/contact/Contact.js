        ...
        <div class="container">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-s-12 ">
            <div class="contact-box">
              <div class="row" >
                <div class="col-lg-6 col-md-6 col-sm-7 col-s-12 ">
                  <div class="col-md-12 col-sm-12" >
                    <div class=" col-lg-12 col-md-12 col-sm-12" >
                      <div class="media-title" style={{marginLeft:'15%'}}>
                        <h2>{t("f-m-t")}</h2>
                      </div>
                      <ul class="social-icons" style={{marginLeft:'12%', marginTop:'5%'}}>
                        <li>
                          <a class="facebook">
                ...
                <div class="col-lg-5 col-md-5 col-sm-7 col-s-12 form-space" style={{ marginTop: '-5%' }}  >
