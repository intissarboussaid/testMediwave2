    ...
    <div>
      ...
      >
        <div class="tp-banner-container ">
          <div class="tp-banner " style={{ width: "100%", height: height+"px", backgroundImage: `url(${img})`, top: '0', left: '0', backgroundSize:'cover' }}>
                

            <div class="">
              <div style={{zIndex:'11'}}>
                <div
                  class="tp-caption small_text titleHeader"
                  style={titleStyle}
                >
                  STERIWAVE: 
                </div>
                <div
                  class="tp-caption small_text subTitleHeader"
                  style={subTitleStyle}
                >
