    ...
    <div>
      <section id="blog-section">
        <div class="container-fluid">
          ...
          <div class="blog-box">
            <div class="row">
              <div class="col-md-4 col-sm-5 blog1" style={{background:'white', boxShadow: '0 30px 50px #505050',borderRadius: '5%', right:'1%'}}>
                <motion.div
                  whileHover={{ y: -6 }}
              ...
              <div class="col-md-4 col-sm-5 blog2" style={{background:'white', boxShadow: '0 30px 50px #505050',borderRadius: '5%'}}>
                <motion.div
                  whileHover={{ y: -6 }}
                  transition={{ duration: 0.2 }}
                  class="blog-post"
              ...
              <div class="col-md-4 col-sm-5 blog3" style={{background:'white', boxShadow: '0 30px 50px #505050',borderRadius: '5%',left:'1%'}}>
                <motion.div
                  whileHover={{ y: -6 }}
                  transition={{ duration: 0.2 }}
                  class="blog-post"
                >
                  <div class="post-gallery">
                    <img src={blog3} class="col-md-6" alt="" height={250} style={{marginTop:'0%',width:'150%', right:'7.2%',borderRadius: '4%'}} />
                  </div>
                  {/* <span>12 December 2018</span> */}
                  <h2>
                    <a 
